...
have never bought anything. The marketplace is held up by a 0.56% sliver of
...
1. **[The Ghost Marketplace](https://leodid68.github.io/01-the-ghost-marketplace.html)**: Data quality, distributions, activation funnel, six segments, power-user deep dive.
2. **[Geography, Gender & the App Effect](https://leodid68.github.io/02-geography-gender-app.html)**: Choropleth of activation by country, gender behavioural splits, the 8× app multiplier, social-vs-transactional decoupling, and the Tableau-ready export.
...
│   └── 6M-0K-99K.users.dataset.public.csv      # 98,913 users × 25 columns
